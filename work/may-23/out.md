...
list of all files to be used in producing record-by-record versioning, as per [[may-23/log]] s `25 may` no 1[^table extracted fm [[out-sup0.tsv]] / beginning *dd* digits in path are file id as in s 2.3.3 above / *dd.dddd.dddd* digits in vers are fit-for-versioning values fm s 2.3.3 above (for series *MS.ACEF.LOTW*).][^[[out-sup0.tsv]] more fully describes files to be used for versioning. file, bytes vars fm `pre-git-hist/files.tsv`, though file vals updated to build github urls. pre-git-hist/files.tsv-row var gives file row number in the said tsv. id, start, path, dates, topics, notes vars fm `v-log` s 5 `files`. m, s, a, c, e, f, l, o, t, w, notes vars fm s 2.3.3 above. 25may-log-path var generated fm file, path, id vars to better navigate working directory. github urls for ease.]
...
| 02.tsv | [link](https://github.com/aenavidad/pre-git-hist/blob/main/files/red/rep%20bz%20fin%20pub%201.3_stable.tsv) | 01.1111.1011 | updated *m* for \*.tsv |
...
| 20-disasters-1-e1—48---disaste | [link](https://github.com/aenavidad/pre-git-hist/blob/main/files/red/prelim%20rep%20bz%201.6%20Disasters-1-E1—48%20%20%20Disasters..tsv) | 00.1010.1000 | updated *m, s* for \*.tsv[^file errors-a1–14\*.tsv m val 1 prev misidentified as id 20, leading to m val 1 for id 20 file, updated m val for id 20 file is 0. similarly for s val. `out-sup0` not updated updated 25 may 17.05.] |
| 20-disasters-e1—48---disasters | [link](https://github.com/aenavidad/pre-git-hist/blob/main/files/red/prelim%20rep%20bz%201.6%20Disasters-E1—48%20%20%20Disasters..tsv) | 00.1010.1000 | updated *m, s* for \*.tsv[^file errors-a1–14\*.tsv m val 1 prev misidentified as id 20, leading to m val 1 for id 20 file, updated m val for id 20 file is 0. similarly for s val. `out-sup0` not updated updated 25 may 17.05.] |
| 20-disastrous-even-e---disastr | [link](https://github.com/aenavidad/pre-git-hist/blob/main/files/red/prelim%20rep%20bz%201.6%20Disastrous-Even%20E%20%20%20Disastrous%20events..tsv) | 00.1010.1000 | updated *m, s* for \*.tsv[^file errors-a1–14\*.tsv m val 1 prev misidentified as id 20, leading to m val 1 for id 20 file, updated m val for id 20 file is 0. similarly for s val. `out-sup0` not updated updated 25 may 17.05.] |
| 20-estimates-d1—29---pre-censa | [link](https://github.com/aenavidad/pre-git-hist/blob/main/files/red/prelim%20rep%20bz%201.6%20Estimates-D1—29%20%20%20Pre-censal%20estimates%20of%20population%20or%20of%20proxies%20for%20population..tsv) | 00.1010.1000 | updated *m, s* for \*.tsv[^file errors-a1–14\*.tsv m val 1 prev misidentified as id 20, leading to m val 1 for id 20 file, updated m val for id 20 file is 0. similarly for s val. `out-sup0` not updated updated 25 may 17.05.] |
| 20-non-disastrous-odd-e---non- | [link](https://github.com/aenavidad/pre-git-hist/blob/main/files/red/prelim%20rep%20bz%201.6%20Non-disastrous-Odd%20E%20%20%20Non-disastrous%20events..tsv) | 00.1010.1000 | updated *m, s* for \*.tsv[^file errors-a1–14\*.tsv m val 1 prev misidentified as id 20, leading to m val 1 for id 20 file, updated m val for id 20 file is 0. similarly for s val. `out-sup0` not updated updated 25 may 17.05.] |
| 20-population-g1—383---populat | [link](https://github.com/aenavidad/pre-git-hist/blob/main/files/red/prelim%20rep%20bz%201.6%20Population-G1—383%20%20%20Population..tsv) | 00.1010.1000 | updated *m, s* for \*.tsv[^file errors-a1–14\*.tsv m val 1 prev misidentified as id 20, leading to m val 1 for id 20 file, updated m val for id 20 file is 0. similarly for s val. `out-sup0` not updated updated 25 may 17.05.] |
| 20-treasury-rate-h1—383---trea | [link](https://github.com/aenavidad/pre-git-hist/blob/main/files/red/prelim%20rep%20bz%201.6%20Treasury%20rate-H1—383%20%20%20Treasury%20rate..tsv) | 00.1010.1000 | updated *m, s* for \*.tsv[^file errors-a1–14\*.tsv m val 1 prev misidentified as id 20, leading to m val 1 for id 20 file, updated m val for id 20 file is 0. similarly for s val. `out-sup0` not updated updated 25 may 17.05.] |
...
| 27-press-table-1.tsv | [link](https://github.com/aenavidad/pre-git-hist/blob/main/files/red/dis%20<%201820%20non-hurr%203.7%20sources%20Press-Table%201.tsv) | 01.0010.0000 | updated *e* for \*.tsv[^`out-sup0` not updated 25 may 21.51] |
| 27-print-table-1.tsv | [link](https://github.com/aenavidad/pre-git-hist/blob/main/files/red/dis%20<%201820%20non-hurr%203.7%20sources%20Print-Table%201.tsv) | 01.0010.0000 | updated *e* for \*.tsv[^`out-sup0` not updated 25 may 21.51] |
| 27-state-table-1.tsv | [link](https://github.com/aenavidad/pre-git-hist/blob/main/files/red/dis%20<%201820%20non-hurr%203.7%20sources%20State-Table%201.tsv) | 01.0010.0000 | updated *e* for \*.tsv[^`out-sup0` not updated 25 may 21.51] |
